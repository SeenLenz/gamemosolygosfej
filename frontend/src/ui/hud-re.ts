...
export class gamePlayHud {
    ...
    constructor() {
        ...
        this.health_potion_parent = document.createElement(
            "div"
        ) as HTMLDivElement;
        this.buff_potion_parent = document.createElement(
            "div"
        ) as HTMLDivElement;
        this.timer = document.createElement("label") as HTMLLabelElement;
        this.current_health = 8;

        this.health_bar.setAttribute(
            "style",
            "position: absolute; top: 1vh; left: 1vw; height: 10vh; width: 15vw; image-rendering: pixelated;"
        );
        this.set_health_bar(0, 1);

        this.health_potion_parent.setAttribute(
            "style",
            "position: relative; top: 14vh; left: 1vw; height: 5vh; width: 10vw;"
        );

        this.buff_potion_parent.setAttribute(
            "style",
            "position: relative; top: 17vh; left: 1vw; height: 5vh; width: 10vw"
        );

        const timer_bg = new Image();
        timer_bg.src = "./textures/hud/timer_bg.png";
        timer_bg.setAttribute(
            "style",
            "position: absolute; top: 3vh; left: 46vw; width: 8vw; height: 5vh; image-rendering: pixelated;"
        );
        this.timer.setAttribute(
            "style",
            'position: absolute; top: 3vh; left: 46vw; height: 5vh; width: 8vw; font-family: "press start 2p"; text-align: center; line-height: 5vh;'
        );
        ...
        for (let i = 0; i < 3; i++) {
            ...
            health_potion.setAttribute(
                "style",
                `position: absolute; left: ${
                    3 * i
                }vw; height: 4vh; width: 3vw; image-rendering: pixelated;`
            );
    ...
    set_health_bar(change: number, multiplyer: number) {
        ...
        this.health_bar.src = `./textures/hud/health_bar/HealthBar-${
            health_bar_states[8 - this.current_health]
        }.png`;
    }
